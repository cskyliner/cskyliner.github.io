...
![image-34.png](/assets/img/posts/CV/image-34.png)
...
![image-35.png](/assets/img/posts/CV/image-35.png)
...
![image-20.png](/assets/img/posts/CV/image-20.png)
...
![image-36.png](/assets/img/posts/CV/image-36.png)
...
- $\hat{x_{ij}} = proj(P_{i}X_{j})$, $w_{ij}$ 表示观测权重（如果点 $j$ 在图像 $i$ 中可见，则 $w_{ij}=1$，否则为 0）。
  ![image-37.png](/assets/img/posts/CV/image-37.png)
